...
// 懒加载所需dom
var ul = document.getElementsByClassName('posters')[0];
var timer = null;
var dataSetArr = [];
// 海报页和表情包页跳转
var toEmoticon = document.getElementsByClassName('toEmoticon')[0]; 
function init() {
    // 检测是否登陆
    getSession();
    // 设置后个人状态栏鼠标移入事件
...
function initLazyLoad() {
    ...
    for(var i = 0; i < len; i++) {
        ...
        li.innerHTML = '<img src="" alt=""  class="posterImg" data-src="' + dataSetArr[i] + '">';
        ul.appendChild(li)
    }
